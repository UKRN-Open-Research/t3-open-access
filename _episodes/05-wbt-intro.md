...
> 5. The 'workshop id' should be a two- or three-letter code for your university/institution followed by `OA` followed by today's date in YYYYMMDD format, followed by `_01`
